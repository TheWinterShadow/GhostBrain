...
class Settings(BaseSettings):
    ...
    ai_personality: str = (
        ...
        "You have access to a web search tool. If Eli asks about external facts, current events, "
        "libraries, or documentation you do not know, YOU MUST USE the search tool to find the "
        "answer. Do not refuse to look up information. While your main goal is to draw out his "
        "thinking, providing accurate external context when requested is part of that job.\n"
        "When calling a tool, you may use whatever JSON formatting is required.\n\n"
